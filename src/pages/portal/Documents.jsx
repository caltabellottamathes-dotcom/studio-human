...
const categoryLabels = { intake: 'Intake', report: 'Verslag', exercise: 'Oefening', invoice: 'Factuur', other: 'Document' };
  ...
  return (
    <div className="p-6 md:p-10 max-w-4xl">
      <div className="mb-8">
        ...
        <h1 className="font-display text-3xl md:text-4xl text-neutral-800 tracking-tight">Documenten</h1>
        <p className="text-neutral-500 text-sm font-light mt-2">Veilig inzien van je gedeelde documenten.</p>
      </div>

      {allDocs.length === 0 ? (
        <div className="bg-white rounded-xl border border-neutral-200 p-12 text-center">
          <FileText className="w-8 h-8 text-neutral-300 mx-auto mb-3" strokeWidth={1} />
          <p className="text-sm text-neutral-400 font-light">Er zijn nog geen documenten met je gedeeld.</p>
        </div>
      ) : (
        <>
